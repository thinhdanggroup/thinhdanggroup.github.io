...
toc_sticky: true
header:
    overlay_image: /assets/images/k9s-cli/banner.webp
    og_image: /assets/images/k9s-cli/og.jpg
    overlay_filter: 0.5
    teaser: /assets/images/k9s-cli/teaser.webp
...
categories:
    - infrastructure
description: "K9s is this cool CLI tool that makes handling Kubernetes a breeze. It’s like having a handy guide for all your app management needs."
...
![commands](/assets/images/k9s-cli/commands.webp){: width="1200" height="912" loading="lazy" decoding="async"}
