...
toc_sticky: true
header:
    overlay_image: /assets/images/10-redis-locks/banner.webp
    og_image: /assets/images/10-redis-locks/og.jpg
    overlay_filter: 0.5
    teaser: /assets/images/10-redis-locks/teaser.webp
...
categories:
    - databases
description: "In this blog post, we will explore the fascinating world of distributed locking mechanisms using Redis."
...
![Simple Atomic Lock](/assets/images/10-redis-locks/simple-atomic-lock/diagram_5.png){: width="632" height="683" loading="lazy" decoding="async"}
...
![Expiring Lock](/assets/images/10-redis-locks/expiring-lock/diagram_3.png){: width="697" height="1036" loading="lazy" decoding="async"}
...
*Diagram explaining the flow of acquiring and releasing an Expiring Lock*
## 3. Redlock Algorithm
...
![Redlock Algorithm](/assets/images/10-redis-locks/redlock-algorithm/diagram_3.png){: width="784" height="636" loading="lazy" decoding="async"}
...
![Semaphore](/assets/images/10-redis-locks/semaphore/diagram_3.png){: width="676" height="1011" loading="lazy" decoding="async"}
...
![Fair Lock](/assets/images/10-redis-locks/fair-lock/diagram.png){: width="698" height="694" loading="lazy" decoding="async"}
...
![Read-Write Lock](/assets/images/10-redis-locks/read-write-lock/diagram.png){: width="784" height="649" loading="lazy" decoding="async"}
...
![Reentrant Lock](/assets/images/10-redis-locks/reentrant-lock/diagram.png){: width="734" height="801" loading="lazy" decoding="async"}
...
![Multi-key Lock](/assets/images/10-redis-locks/multi-key-lock/diagram.png){: width="450" height="907" loading="lazy" decoding="async"}
...
![Zookeeper-style Lock](/assets/images/10-redis-locks/zookeeper-style-lock/diagram.png){: width="593" height="784" loading="lazy" decoding="async"}
...
![Lease Lock](/assets/images/10-redis-locks/lease-lock/diagram.png){: width="450" height="545" loading="lazy" decoding="async"}
