...
toc_sticky: true
header:
    overlay_image: /assets/images/lodash-fp/banner.webp
    og_image: /assets/images/lodash-fp/og.jpg
    overlay_filter: 0.5
    teaser: /assets/images/lodash-fp/teaser.webp
...
categories:
    - web-development
description: "Start your journey into the functional programming paradigm with Lodash, a powerful JavaScript utility library that includes Lodash FP."
