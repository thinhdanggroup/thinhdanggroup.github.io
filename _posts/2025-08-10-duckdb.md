...
toc_sticky: true
header:
    overlay_image: /assets/images/duckdb/banner.webp
    og_image: /assets/images/duckdb/og.jpg
    overlay_filter: 0.5
    teaser: /assets/images/duckdb/teaser.webp
...
categories:
    - databases
description: "Tired of slow local data analysis? This post breaks down DuckDB, the game-changing in-process database."
