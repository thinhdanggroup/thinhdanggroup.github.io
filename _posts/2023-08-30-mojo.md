...
toc_sticky: true
header:
    overlay_image: /assets/images/mojo/banner.webp
    og_image: /assets/images/mojo/og.jpg
    overlay_filter: 0.5
    teaser: /assets/images/mojo/teaser.webp
...
categories:
    - python
description: "In this blog post, we will explore Mojo, a new programming language that aims to revolutionize the world of AI."
...
![mojo_vs_python](/assets/images/mojo/mojo_vs_python.jpeg){: width="516" height="97" loading="lazy" decoding="async"}
...
![coding](/assets/images/mojo/coding.png){: width="1200" height="473" loading="lazy" decoding="async"}
