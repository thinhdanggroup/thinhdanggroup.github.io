...
categories:
    - infrastructure
description: "Knative is a powerful open-source platform that simplifies the development and deployment of serverless applications on Kubernetes."
...
![serving](/assets/images/knative/serving.png){: width="938" height="436" loading="lazy" decoding="async"}
...
![eventing](/assets/images/knative/eventing.png){: width="589" height="552" loading="lazy" decoding="async"}
