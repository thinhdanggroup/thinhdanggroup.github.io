...
toc_sticky: true
header:
  overlay_image: /assets/images/temporal/temporal.webp
  og_image: /assets/images/temporal/og.jpg
  overlay_filter: 0.5 
  teaser: /assets/images/temporal/temporal-teaser.webp
title:  "How I Built Reliable and Scalable Applications with Temporal"
tags:
    - Temporal
description: "As a software developer, I have always been interested in building complex applications that involve multiple microservices, asynchronous tasks, long-running…"
