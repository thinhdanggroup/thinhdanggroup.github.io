...
toc_sticky: true
header:
    overlay_image: /assets/images/gemini/banner.webp
    og_image: /assets/images/gemini/og.jpg
    overlay_filter: 0.5
    teaser: /assets/images/gemini/teaser.webp
...
categories:
    - ai-engineering
description: "In this comprehensive guide, we delve into the world of fine-tuning the generationconfig and safety settings of the Gemini AI model."
