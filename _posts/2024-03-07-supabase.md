...
toc_sticky: true
header:
    overlay_image: /assets/images/supabase/banner.webp
    og_image: /assets/images/supabase/og.jpg
    overlay_filter: 0.5
    teaser: /assets/images/supabase/teaser.webp
...
categories:
    - infrastructure
description: "Supabase is a powerful and easy-to-use backend platform that can help you build scalable, secure, and real-time web applications."
